...
const ChatSidebarItem = ({ name, image, status, lastMessage, lastMessageTime, clickHandler }: ChatSidebarItemProps) => {
    return (
        <div className="flex justify-between group hover:text-white hover:bg-linear-to-r hover:from-(--color-light-blue) hover:to-(--color-purple)">
