...
messageReceiptRouter.get('/by-id/:id', 
    [
...
messageReceiptRouter.get('/by-message-id/:messageId', 
    [
...
messageReceiptRouter.get('/by-user-id/:userId', 
    [
...
messageReceiptRouter.get('/by-message-id-and-user-id/:messageId/:userId', 
    [
        param('messageId').isString().notEmpty(),
        param('userId').isString().notEmpty(),
    ],
...
messageReceiptRouter.get('/date-range/:startDate/:endDate', 
    [
